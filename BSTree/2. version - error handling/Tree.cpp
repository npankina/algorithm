...
//typename BSTree<T>::template Tree_Iterator<T, Pointer, Reference>::Tree_Iterator() : current_(nullptr)
//{}
//----------------------------------------------------------------------------------------------------
//template <typename T, typename Pointer, typename Reference>
//typename BSTree<T>::template Tree_Iterator<T, Pointer, Reference>::Tree_Iterator(typename BSTree<T>::Node *node)
//: Tree_Iterator()
...
//----------------------------------------------------------------------------------------------------
//template <typename T, typename Pointer, typename Reference>
//typename BSTree<T>::template 
//Tree_Iterator<T, Pointer, Reference>::reference 
//typename BSTree<T>::template Tree_Iterator<T, Pointer, Reference>::operator*() const
//{}
////----------------------------------------------------------------------------------------------------
//template <typename T, typename Pointer, typename Reference>
//typename BSTree<T>::template Tree_Iterator<T, Pointer, Reference>::pointer
//typename BSTree<T>::template Tree_Iterator<T, T*, T&>::operator->() const
//{}
////----------------------------------------------------------------------------------------------------
//template <typename T, typename Pointer, typename Reference>
//typename BSTree<T>::template 
//Tree_Iterator<T, Pointer, Reference>&
//typename BSTree<T>::template Tree_Iterator<T, Pointer, Reference>::operator++()
//{}
////----------------------------------------------------------------------------------------------------
//template <typename T, typename Pointer, typename Reference>
//bool typename BSTree<T>::template Tree_Iterator<T, Pointer, Reference>::operator++(int)
//{}
////----------------------------------------------------------------------------------------------------
//template <typename T, typename Pointer, typename Reference>
//bool typename BSTree<T>::template 
...
////----------------------------------------------------------------------------------------------------
//template <typename T, typename Pointer, typename Reference>
//void typename BSTree<T>::template Tree_Iterator<T, Pointer, Reference>::Push_left(typename BSTree<T>::Node *node)
//{
//}
////----------------------------------------------------------------------------------------------------